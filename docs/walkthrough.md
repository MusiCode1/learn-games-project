...
## 2026-01-15 - תוכנית איחוד המשחקים

### 📋 מה בוצע

נוצרה תוכנית מקיפה לאיחוד כל המשחקים לפרויקט משותף.

**מסמך התוכנית:** [docs/games-unification-plan.md](./games-unification-plan.md)

### 🎯 סיכום התוכנית

#### המשחקים הקיימים:
- **wordys-game** - משחק התאמת מילים לתמונות
- **lotto-game** - משחק לוטו אותיות/צורות
- **train-addition-game** - משחק רכבת החיבור (חשבון)
- **read-faster** - תרגול קריאה מהירה

#### האסטרטגיה המומלצת: גישה היברידית

1. **שלב 1 (מיידי)**: יצירת Hub מרכזי ב-`apps/main` עם דף בחירת משחקים
2. **שלב 2 (קצר-בינוני)**: הרחבת `learn-booster-kit` עם רכיבים משותפים
3. **שלב 3 (עתידי)**: מיזוג הדרגתי של משחקים דומים
