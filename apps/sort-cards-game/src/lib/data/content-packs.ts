  ...
  rounds: [
    {
      ...
      cards: [
        ...
        { id: "d1", content: "", categoryId: "power", image: "בָּ", ttsText: "בָּ" },
        { id: "d2", content: "", categoryId: "power", image: "גָ", ttsText: "גָ" },
        { id: "d3", content: "", categoryId: "power", image: "דָּ", ttsText: "דָּ" },
        { id: "d4", content: "", categoryId: "power", image: "כָּ", ttsText: "כָּ" },
        { id: "d5", content: "", categoryId: "power", image: "פָ", ttsText: "פָ" },
        { id: "d6", content: "", categoryId: "power", image: "תָּ", ttsText: "תָּ" },
        // אותיות בלי תנועה (אין כוח — עיצור עם שווא)
        { id: "d7", content: "", categoryId: "no-power", image: "בּ", ttsText: "בְּ" },
        { id: "d8", content: "", categoryId: "no-power", image: "ג", ttsText: "גְ" },
        { id: "d9", content: "", categoryId: "no-power", image: "דּ", ttsText: "דְּ" },
        { id: "d10", content: "", categoryId: "no-power", image: "כּ", ttsText: "כְּ" },
        { id: "d11", content: "", categoryId: "no-power", image: "פ", ttsText: "פְ" },
        { id: "d12", content: "", categoryId: "no-power", image: "ת", ttsText: "תְ" },
      ],
    },
    {
      id: "yk-2",
      ...
      cards: [
        ...
        { id: "d13", content: "", categoryId: "power", image: "כָ", ttsText: "כָ" },
        { id: "d14", content: "", categoryId: "no-power", image: "כ", ttsText: "כְ" },
        { id: "d15", content: "", categoryId: "power", image: "פָּ", ttsText: "פָּ" },
        { id: "d16", content: "", categoryId: "no-power", image: "פּ", ttsText: "פְּ" },
        { id: "d17", content: "", categoryId: "power", image: "בָ", ttsText: "בָ" },
        { id: "d18", content: "", categoryId: "no-power", image: "ב", ttsText: "בְ" },
        { id: "d19", content: "", categoryId: "power", image: "תָ", ttsText: "תָ" },
        { id: "d20", content: "", categoryId: "no-power", image: "תּ", ttsText: "תְּ" },
        { id: "d21", content: "", categoryId: "power", image: "גָּ", ttsText: "גָּ" },
        { id: "d22", content: "", categoryId: "no-power", image: "גּ", ttsText: "גְּ" },
        { id: "d23", content: "", categoryId: "power", image: "דָ", ttsText: "דָ" },
        { id: "d24", content: "", categoryId: "no-power", image: "ד", ttsText: "דְ" },
      ],
    },
  ],
};
