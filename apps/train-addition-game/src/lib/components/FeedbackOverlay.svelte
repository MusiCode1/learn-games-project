...
{#if isVisible}
	<div class="fixed inset-0 z-50 flex items-center justify-center">
		{#if isCorrect}
			...
			<div class="animate-success rounded-3xl bg-gradient-to-br from-green-400 to-green-600 px-16 py-10 text-center text-white shadow-2xl">
				<!-- כוכבים מסביב -->
				<div class="stars">
		...
		{:else if isWrong}
			...
			<div class="animate-shake rounded-3xl bg-gradient-to-br from-orange-400 to-orange-600 px-12 py-8 text-center text-white shadow-2xl">
