...
<div class="flex flex-col items-center gap-4">
  ...
  <button
    ...
    class="group relative flex items-center justify-center gap-3 rounded-2xl
		px-4 py-2 text-base sm:px-6 sm:py-3 sm:text-lg md:px-8 md:py-4 md:text-xl font-bold text-white shadow-xl transition-all duration-300
			{isActive
  ...
  >
    ...
    <svg
      class="h-6 w-6 sm:h-8 sm:w-8 md:h-8 md:w-8 transition-transform duration-300 group-hover:rotate-90 group-hover:scale-110"
      fill="none"
      stroke="currentColor"
      viewBox="0 0 24 24"
    >
