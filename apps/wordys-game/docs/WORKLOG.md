...
הוגדרו גדלי המסכים ומכשירי היעד של הפרויקט לטובת התאמה מיטבית של הממשק.

### משימות שבוצעו

- **הגדרת מכשירי יעד**: נוצר מסמך `docs/design-specs.md` המגדיר את מכשירי היעד (CUBOT Tab KingKong, iPad Air, Desktop, Mobile) והרזולוציות הנתמכות.
- **עדכון נתוני CUBOT**: עודכן כי ה-Viewport האפקטיבי של המכשיר הוא 1097x685 (ולא הרזולוציה הפיזית המלאה), מה שמשפיע על בדיקות ה-Responsive.
- **החלטות עיצוביות**: נקבעו עקרונות לשימוש ב-Container Queries ותמיכה באוריינטציות שונות.
